...
const LibraryScreen = () => {
  ...
  const handleDeleteElement = elementID => {
    booksData.forEach(element => {
      if (element.id === elementID) {
        deleteDoc(doc(db, 'books', elementID));
  ...
  const handleDoneButton = elementID => {
    booksData.forEach(element => {
      if (element.id === elementID) {
        ...
        addDoc(collection(db, 'booksHistory'), {
          id: id,
          picture: picture,
          title: title,
          author: author,
        ...
        console.log('Add element with id: ' + elementID + 'to booksHistory.');
        setID(id + 1);
      }
    });
  };
          ...
          <View style={styles.textBookContainerView}>
            ...
            <View style={styles.buttonContainer}>
              <TouchableOpacity
                ...
                onPress={() => handleDoneButton(element.id)}>
